 ...
 * </ol>
 */
public class AWRAnalysis extends CommandLineUtility {
	...
	public Options getOptions() {
		...
		options.addOption(OptionBuilder
				...
				.hasArg()
				.withArgName("value")
				.withDescription("Threshold to calculate attainment")
				.create('a'));
	...
	public void run(CommandLine commandLine) throws Exception {
		...
		if (metric == 0) {
			if (commandLine.hasOption("hypervolume")) {
				//threshold = 0.5 * Double.parseDouble(
				//		commandLine.getOptionValue("hypervolume"));
				threshold = Double.parseDouble(commandLine.getOptionValue("threshold"))
            * Double.parseDouble(commandLine.getOptionValue("hypervolume"));
			} else {
